        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                { 
                    ...
                    {
                        case "2015":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                                + "'chk15', "
                        ...
                        case "2012":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                                ...
                                + "'2012',"
                                + "'https://www.cdc.gov/brfss/annual_data/2012/pdf/codebook12_llcp.pdf',"
                                + "'chk12708224')");
                            break;
                        case "2011":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                        ...
                        case "2009":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                                ...
                                + "'2009',"
                                + "'https://www.cdc.gov/brfss/annual_data/2009/pdf/codebook_09.pdf',"
                                + "'chk09707168')");
                            break;
                        case "2008":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                        ...
                        case "2007":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                                ...
                                + "'2007',"
                                + "'https://www.cdc.gov/brfss/annual_data/2007/pdf/codebook_07.pdf',"
                                + "'chk07706464')");
                            break;
                        case "2006":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                                ...
                                + "'2006',"
                                + "'https://www.cdc.gov/brfss/annual_data/2006/pdf/codebook_06.pdf',"
                                + "'chk06706112')");
                            break;
                        case "2005":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                                ...
                                + "'2005',"
                                + "'https://www.cdc.gov/brfss/annual_data/2005/pdf/codebook_05.pdf',"
                                + "'chk05705760')");
                            break;
                        case "2004":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                        ...
                        case "2003":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                                ...
                                + "'2003',"
                                + "'https://www.cdc.gov/brfss/annual_data/2003/pdf/codebook_03.pdf',"
                                + "'chk03705056')");
                            break;
                        case "2002":
                            item.Attributes.Add("onclick", "ShowColumns2(this,"
                                ...
                                + "'2002',"
                                + "'https://www.cdc.gov/brfss/annual_data/2002/pdf/codebook_02.pdf',"
                                + "'chk02704704')");

                ...
                { 
                    ...
                    switch (itemName)
                    {
                        case "2015":
                            ...
                            item.Attributes.Add("onclick", "alert('Congrats, you have clicked 2015!  Yay! \n " + item.Attributes["columnname"].ToString() + "')");
                            break;
                        case "2014":
                            ...
                            item.Attributes.Add("onclick", "alert('Aww, you are only able to click 2014. :(')");
                            break;
                        case "2013":
                        ...
                        case "2012":
                            ...
                            item.Attributes.Add("onclick", "alert("+item.Attributes["columnname"].ToString()+")");
                            break;
                        case "2011":
